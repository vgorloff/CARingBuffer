...
require "#{gitRepoDirPath}/Vendor/WL/Scripts/lib/FileHeaderChecker.rb"
require "#{gitRepoDirPath}/Vendor/WL/Scripts/lib/Tool.rb"
require "#{gitRepoDirPath}/Vendor/WL/Scripts/lib/GitStatus.rb"
