...
func generateSampleChannelData(buffer: AVAudioPCMBuffer, numberOfFrames: UInt32, biasValue: UInt32 = 1) {
...
func printChannelData(title title: String, buffer: AVAudioPCMBuffer) {
	print(title)
	let ablPointer = UnsafeMutableAudioBufferListPointer(buffer.mutableAudioBufferList)
...
func compareBuffersContents(writeBuffer: AVAudioPCMBuffer, writeBufferOffset: UInt32,
...
func checkBuffersContentsIsZero(buffer: AVAudioPCMBuffer, bufferOffset: UInt32, numberOfFrames: UInt32) -> Bool {
